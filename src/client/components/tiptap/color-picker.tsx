...
export const ColorButton: React.FC<ColorButtonProps> = ({ color, isSelected, inverse, onClick }) => {
...
export const ColorPicker: React.FC<ColorPickerProps> = ({ palette, selectedColor, inverse, onColorChange }) => (
	<ToggleGroup
		type="single"
		value={selectedColor}
