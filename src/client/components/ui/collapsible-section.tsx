	...
	return (
		<Collapsible open={isOpen} className="space-y-4" {...props}>
			<CollapsibleTrigger asChild>
				<h2
					className="group/collapsible-section flex items-center gap-x-2 text-xl underline-offset-2 hover:cursor-pointer hover:underline md:min-w-[350px]"
					...
					<Tooltip>
						<TooltipTrigger asChild>
							<Button
								size="sm"
								variant="ghost"
								className="ml-auto flex size-8 items-center gap-1 rounded-lg p-0 group-hover/collapsible-section:bg-accent group-hover/collapsible-section:text-accent-foreground"
							>
