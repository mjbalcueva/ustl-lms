...
export const TwoFactorTokenEmail = ({ email, token }: TwoFactorTokenEmailProps) => {
	return (
		<Html>
			...
			<Tailwind>
				<Body className="mx-auto my-auto bg-neutral-100 font-sans text-neutral-950">
					<Container className="rounded border border-solid border-[#eaeaea] bg-white px-10 pb-10">
						...
						<Section>
							...
							<Text>
								You are receiving this email because you are attempting to sign in to your account using{' '}
								<strong>two-factor authentication</strong>. Please enter the following code in your browser to complete
								the sign-in process:
							</Text>
							<Section>
								<CodeInline className="bg-neutral-200/60 px-14 text-3xl font-semibold tracking-widest text-neutral-950">
									{token}
								</CodeInline>
							</Section>
							<Text>
							...
							<Text>To keep your account secure, please do not share this code with anyone.</Text>
