...
import { Loader2 as Loader2Icon, Loader as LoaderIcon } from '@/core/lib/icons'
...
const Ring = React.memo((props: any) => <LoaderIcon {...props} />)
Ring.displayName = 'Ring'

// eslint-disable-next-line @typescript-eslint/no-explicit-any
const Spin = React.memo((props: any) => <Loader2Icon {...props} />)
