...
export const CardTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
	({ className, ...props }, ref) => (
		<h3
			ref={ref}
			className={cn('w-fit text-lg font-medium leading-none tracking-tight', className)}
			{...props}
		/>
	)
)
...
export const CardInnerCard = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
	({ className, ...props }, ref) => (
