				...
				<Body className="mx-auto my-auto bg-neutral-100 py-6 font-sans text-neutral-950">
					<Container className="rounded-xl border border-solid border-[#eaeaea] bg-white px-10 pb-10">
						...
						<Section>
							...
							<Text>
								You are receiving this email because you are attempting to sign in to your account
								using <strong>two-factor authentication</strong>. Please enter the following code in
								your browser to complete the sign-in process:
							</Text>
							<Section>
